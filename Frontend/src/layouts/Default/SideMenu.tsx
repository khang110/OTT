  ...
  return (
    ...
    >
      ...
      <DropdownMenu>
        ...
        >
          Cá nhân <i className="bx bx-user-circle text-muted ms-1"></i>
        </DropdownItem>
        <DropdownItem
          className="d-flex align-items-center justify-content-between"
          onClick={() => onChangeTab(TABS.SETTINGS)}
        >
          Cài đặt <i className="bx bx-cog text-muted ms-1"></i>
        </DropdownItem>
        <DropdownItem
          className="d-flex align-items-center justify-content-between"
          href="/auth-changepassword"
        >
          Đổi mật khẩu <i className="bx bx-lock-open text-muted ms-1"></i>
        </DropdownItem>
        ...
        <DropdownItem
          ...
          href="/logout"
        >
          Đăng xuất <i className="bx bx-log-out-circle text-muted ms-1"></i>
        </DropdownItem>
      </DropdownMenu>
    </Dropdown>
  );
